...
package com.distriqt.test.integrity
{
	...
	public class Main extends Sprite implements ILogger
	{
		...
		private var _tests		: IntegrityTests;
		...
		private function createUI():void
		{
			...
			_tests = new IntegrityTests( this );

			
			addAction( "Prepare", _tests.prepare );
			addAction( "Standard Request", _tests.requestToken );
			addAction( "Classic Request", _tests.requestClassicToken );
